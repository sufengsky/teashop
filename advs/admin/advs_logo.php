...
?>
<div class="formzone">
<div class="namezone" style="float:left;margin:10px 10px 0px 10px"><?php echo $strSetMenu7; ?></div>
<div style="float:right;margin-right:3px;margin-top:5px">
<input type="button" name="Button" value="<?php echo $strAdvsLogoAdd; ?>" class="button" onClick="self.location='advs_logo_modi.php?id=0'" /> 
</div>
<div class="tablezone" style="clear:both;">
<table width="100%" border="0" cellspacing="0" cellpadding="5" >
  <tr> 
    <td class="innerbiaoti" align="center" height="28" width="50" ><?php echo $strNumber; ?></td>
    <td width="180" height="28" class="innerbiaoti" ><?php echo $strAdvsLogoName; ?></td>
  ...
  <tr class="list"> 
        ...
        <div id="StDv<?php echo $id; ?>" style="position:absolute; width:100px; height:100px; z-index:1; display: none">
          <table width="100%" border="0" cellspacing="1" cellpadding="1"  bgcolor="#666666" style='border:5px #ffffff solid;'>
            ...
            <tr bgcolor="#FFFFFF" align="center">
              <td  onclick="StDv<?php echo $id; ?>.style.display='none'">
				<?php
				if($src==""){
					echo "";
				}else{
    ...
    <td ><?php echo $url; ?></td>
    <td height="28" width="55" > <img src="images/edit.png"  style="cursor:pointer" onClick="window.location='advs_logo_modi.php?id=<?php echo $id; ?>'"> 
    </td>
    <td height="28" width="55" > <img src="images/delete.png"  style="cursor:pointer" onClick="window.location='advs_logo.php?step=del&id=<?php echo $id; ?>'"> 
    </td>
  </tr>
  <?php
	}
