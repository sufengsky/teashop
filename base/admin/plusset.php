...
$id = substr( $divid, 4 );
$msql->query( "select * from {P}_base_plus where id='{$id}' " );
if ( $msql->next_record( ) )
{
				$id = $msql->f( "id" );
...
if ( $msql->next_record( ) )
{
				...
				$set_ifmul = $msql->f( "ifmul" );
				$set_pluslocat = $msql->f( "pluslocat" );
...
echo " \r\n\r\n<form action=\"plussave.php\" id=\"setForm_";
echo $divid;
echo "\" method=\"post\" enctype=\"multipart/form-data\" name=\"form\" style=\"margin:0px\">\r\n\r\n\r\n\r\n\r\n<div class=\"scrollex\">\r\n\r\n<div class=\"adminnav\">\r\n<div style=\"float:right;display:inline;color:#666;font:12px/18px Arial\">";
...
if ( strstr( $set_ord, "|" ) )
{
				...
				for ( ;	$r < sizeof( $ordArr );	$r++	)
				{
								if ( $ord == $ordArr[$r] )
								{
												echo "<option value='".$ordArr[$r]."' selected>".$ordArr[$r]."</option>";
								}
								else
								{
...
echo "> \r\n              <td width=\"90\">";
echo $strPlusPic;
echo "</td>\r\n              <td >\r\n\t\t\t   <input name=\"jpg\" type=\"file\" id=\"jpg\" class=\"input\" style='WIDTH:300px;' >\r\n\t\t\t   <input name=\"pic\" type=\"hidden\" id=\"pic\" value=\"";
echo $pic;
echo "\">\r\n              </td>\r\n            </tr>\r\n\t\t\t\r\n\t\t\t<tr  ";
...
echo "> \r\n              <td width=\"90\">";
echo $strPlusPicLink;
echo "</td>\r\n              <td>\r\n\t\t\t   <input name=\"piclink\" type=\"text\" class=\"input\" id=\"piclink\" style='WIDTH: 320px;' value=\"";
echo $piclink;
echo "\" >\r\n              </td>\r\n            </tr>\r\n\t\t\t\r\n\t\t\t<tr  ";
...
echo plustrmuldis( $set_setglobal, $set_ifmul, $set_pluslocat );
...
echo ">\r\n\t\t\t   <input name=\"globaldel\" type=\"checkbox\" id=\"globaldel\" value=\"1\" /> \r\n\t\t\t  </td>\r\n\t\t\t \r\n\t\t\t   <td ";
echo plustrdis( $set_setglobal );
echo ">\r\n\t\t\t    ";
echo $strPlusGlobalDel;
echo "\t\t\t  </td>\r\n\t\t\t  \r\n\t\t\t  \r\n\t\t    </tr>\r\n\t\t</table>\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</form>\r\n</body>\r\n</html>\r\n";
?>
