...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function connect($connection_timeout=0,$response_timeout=90){
...
//curl_setopt($this->ch, CURLOPT_CAINFO, 'f:\php-4.3.2-win32\extensions\curl-ca-bundle.crt');		
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=90) {
	...
	* @access   public
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=90) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=90){
        $this->wsdl = $wsdl;
...
* @access   public
*/
class soapclientx extends nusoap_base  {
	...
	var $response_timeout = 90;		// HTTP response timeout
	var $endpointType = '';
	var $persistentConnection = false;
	...
	* @access   public
	*/
	function soapclientx($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 90){
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=90) {
		// detect transport
		switch(true){
			// http(s)
