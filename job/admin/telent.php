...
if ( $step == "addku" )
{
				...
				{
								$ids = $dall[$i];
								$msql->query( "update {P}_job_telent set fav='1' where id='{$ids}'" );
				}
}
if ( 2 < $page )
{
...
echo "<div class=\"searchzone\">\r\n<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" height=\"30\">\r\n  <tr> \r\n   \r\n                  \r\n      <td  height=\"30\"><form method=\"get\" action=\"telent.php\" >\r\n        ";
echo "<s";
...
echo $strDelete;
echo "        &nbsp;\r\n        <input name=\"step\" type=\"radio\" value=\"addku\" />\r\n        ";
echo $strJobAddKu;
