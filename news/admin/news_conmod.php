...
echo $strNewsModify;
echo "</div>\r\n<div class=\"tablezone\">\r\n<div  id=\"notice\" class=\"noticediv\"></div>\r\n      <table class=\"newsmodizone\" width=\"100%\" cellpadding=\"2\" align=\"center\"  border=\"0\" cellspacing=\"0\">\r\n         \r\n\t\t  <tr> \r\n            <td height=\"30\" width=\"100\" align=\"center\" >";
...
echo $title;
echo "\" />\r\n              <font color=\"#FF0000\">*</font> </td>\r\n          </tr>\r\n      </table>\r\n\t<div id=\"proplist\" class=\"newsmodizone\">\r\n\t\r\n\t</div>\r\n\t<table class=\"newsmodizone\" width=\"100%\"   border=\"0\" align=\"center\"  cellpadding=\"2\" cellspacing=\"0\" >\r\n          <tr>\r\n            <td width=\"100\" height=\"30\" align=\"center\" >";
echo $strMemo;
echo "</td>\r\n            <td height=\"30\" ><textarea name=\"memo\" style=\"WIDTH: 499px;\" class=\"textarea\" rows=\"3\">";
echo $memo;
echo "</textarea>\r\n            </td>\r\n          </tr>\r\n          <tr> \r\n            <td height=\"30\" width=\"100\" align=\"center\" >";
echo $strNewsAddImg;
...
echo $strNewsAddCon;
echo "</td>\r\n            <td height=\"30\" > \r\n             <input id=\"newsbody\" type=\"hidden\" name=\"body\" value=\"";
echo $body;
echo "\" />\r\n\t\t\t ";
echo "<s";
...
echo $page;
echo "\" />\r\n\t\t\t \r\n            </td>\r\n          </tr>\r\n\t\t    <tr>\r\n\t\t    <td height=\"30\" align=\"center\" >&nbsp;</td>\r\n\t\t    <td height=\"30\" ><div id=\"newspages\"></div>\r\n\t\t\t</td>\r\n\t    </tr>\r\n\t\t </table>\r\n\t\t \r\n         <table class=\"newsmodizone\" width=\"100%\"   border=\"0\" align=\"center\"  cellpadding=\"2\" cellspacing=\"0\" >\r\n\r\n\t\t  <tr>\r\n      <td height=\"30\" align=\"center\" >";
echo $strNewsTag;
...
echo "</td>\r\n            <td height=\"30\" > \r\n              <input type=\"text\" name=\"author\" style='WIDTH: 499px;' maxlength=\"100\" class=input value=\"";
echo $author;
echo "\" />\r\n            </td>\r\n          </tr>\r\n          <tr> \r\n            <td height=\"30\" width=\"100\" align=\"center\" >";
echo $strNewsAddSource;
echo "</td>\r\n            <td height=\"30\" > \r\n              <input type=\"text\" name=\"source\" style='WIDTH: 499px;' maxlength=\"100\" class=\"input\" value=\"";
echo $source;
echo "\" />\r\n            </td>\r\n          </tr>\r\n\t\t  <tr> \r\n            <td height=\"30\" width=\"100\" align=\"center\" >";
echo $strNewsAddProj;
echo "</td>\r\n            <td height=\"30\" >";
...
echo seld( $downcentid, "1" );
echo ">";
echo $centname1;
echo "</option>\r\n\t\t<option value=\"2\" ";
echo seld( $downcentid, "2" );
echo ">";
echo $centname2;
echo "</option>\r\n\t\t<option value=\"3\" ";
echo seld( $downcentid, "3" );
echo ">";
echo $centname3;
echo "</option>\r\n\t\t<option value=\"4\" ";
echo seld( $downcentid, "4" );
echo ">";
echo $centname4;
echo "</option>\r\n\t\t<option value=\"5\" ";
echo seld( $downcentid, "5" );
echo ">";
echo $centname5;
echo "</option>\r\n\t    </select>\r\n\t\t<input name=\"downcent\" type=\"text\" class=\"input\" id=\"downcent\"  value=\"";
echo $downcent;
...
echo $strFbtime;
echo "</td>\r\n            <td height=\"30\" >\r\n\t\t\t <input name=\"fbtime\" type=\"text\" class=\"input\" id=\"fbtime\"  value=\"";
echo $fbtime;
echo "\" size=\"10\" maxlength=\"10\"   onClick=\"getDateString(this,oCalendarChs)\"  style=\"cursor:pointer\" readonly  />\r\n\t\t\t <input type=\"hidden\" name=\"htime\" value=\"";
echo $htime;
echo "\" />\r\n\t\t\t</td>\r\n          </tr>\r\n          <tr> \r\n            <td height=\"30\" width=\"100\" align=\"center\" >";
echo $strUptime;
echo "</td>\r\n            <td height=\"30\" >";
...
echo " </td>\r\n          </tr>\r\n          <tr>\r\n            <td height=\"30\" align=\"center\" >";
echo $strNewsToUrl;
echo "</td>\r\n            <td height=\"30\" ><input name=\"tourl\" type=\"text\" class=\"input\" id=\"tourl\" style='WIDTH: 499px;font-size:12px;' value=\"";
echo $tourl;
echo "\" maxlength=\"200\" />\r\n            </td>\r\n          </tr>\r\n          <tr>\r\n            <td height=\"30\" align=\"center\" >&nbsp;</td>\r\n            <td height=\"30\" >";
